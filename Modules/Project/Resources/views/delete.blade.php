...
<form method="POST" action="">
    ...
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">
            <span class="projTitle">Xóa dự án</span>
        </h4>
    </div>
    <div class="box-body form-scrolling">
        <div class="form-group">
            <label for="projectName">Tên dự án <span class="requiredStar"></span></label>
            <input disabled type="text" class="form-control" name="projectName" id="projectName" placeholder="Tên dự án"  value="{{ $project->name }}">
        </div>
    </div>
    <div class="box-footer text-center">
        <button type="button" class="btn btn-cancel btn-default for-cancel">Hủy</button>
        <button type="submit" class="btn btn-primary for-save">Xóa</button>
    </div>
</form>
@stop
