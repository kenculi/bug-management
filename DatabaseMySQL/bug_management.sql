...
(3, 'Duplicate', 'is duplicated by', 'duplicates'),
...
INSERT INTO `issuestatus` (`id`, `sequence`, `name`, `description`, `icon_url`) VALUES
(1, 1, 'Open', 'The issue is open and ready for the assignee to start work on it.', '/images/icons/statuses/open.png'),
(2, 3, 'To Do', NULL, '/images/icons/status_generic.gif'),
(3, 4, 'Done', NULL, '/images/icons/status_generic.gif'),
(4, 2, 'In Progress', 'This issue is being actively worked on at the moment by the assignee.', '/images/icons/statuses/inprogress.png'),
(5, 5, 'Reopened', 'This issue was once resolved, but the resolution was deemed incorrect. From here issues are either marked assigned or resolved.', '/images/icons/statuses/reopened.png'),
(6, 6, 'Resolved', 'A resolution has been taken, and it is awaiting verification by reporter. From here issues are either reopened, or are closed.', '/images/icons/statuses/resolved.png'),
(7, 7, 'Closed', 'The issue is considered finished, the resolution is correct. Issues which are closed can be reopened.', '/images/icons/statuses/closed.png');
...
(2, 'Duy Vuong Dao', 'duyvuongdao2@gmail.com', '$2y$10$QXpRqxWVskzVMCnN52E2euf3opeC22fSsbS8ZjfYJnohqTV.RRd9.', 1, 256, '', '63e7NaQL9Kx2qrsjz8OL6UbRIeURXD5t3705K19vFLeqZuBjfsBqs9Xy7iux', '2018-11-01 02:40:45', '2018-11-01 02:40:45');
